...
(define-fun n4color () Bool
  (or (and p_4_0 (not p_4_1) (not p_4_2))
      (and p_4_1 (not p_4_0) (not p_4_2))
      (and p_4_2 (not p_4_0) (not p_4_1))))
...
(define-fun edge_1_4 () Bool
  (or (and p_1_0 (not p_4_0)) (and p_1_1 (not p_4_1)) (and p_1_2 (not p_4_2))))
(define-fun edge_2_3 () Bool
  (or (and p_2_0 (not p_3_0)) (and p_2_1 (not p_3_1)) (and p_2_2 (not p_3_2))))
(define-fun edge_2_4 () Bool
  (or (and p_2_0 (not p_4_0)) (and p_2_1 (not p_4_1)) (and p_2_2 (not p_4_2))))
